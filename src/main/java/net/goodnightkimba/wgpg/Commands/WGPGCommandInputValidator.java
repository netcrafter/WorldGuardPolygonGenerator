...
public class WGPGCommandInputValidator extends InputValidator {
    ...
    public boolean validCentreZ(String input) throws UserInputException {
		if (!decimal(input)) throw new UserInputException("must-be-double", input, "double", "centerZ");
		return true;
	}

    public boolean validWorld(String input) throws UserInputException {
		if (!worldName(input)) throw new UserInputException("invalid-world", input, "World Name", "world");
		return true;
	}

    public boolean validCentreX(String input) throws UserInputException {
		if (!decimal(input)) throw new UserInputException("must-be-double", input, "double", "centerX");
		return true;
	}

    public boolean validRegionName(String input) throws UserInputException {
    ...
    public boolean validMaxY(String input) throws UserInputException {
    ...
    public boolean validRangeY(String minY, String maxY) throws UserInputException {
    ...
    public boolean validRadiusX(String input) throws UserInputException {
    ...
    public boolean validRadiusZ(String input) throws UserInputException {
    ...
    public boolean validNumberOfPoints(String input) throws UserInputException {
	...
	public boolean validOffSet(String input) throws UserInputException {
